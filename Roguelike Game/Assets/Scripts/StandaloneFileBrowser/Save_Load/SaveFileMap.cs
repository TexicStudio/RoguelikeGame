...
public class SaveFileMap : MonoBehaviour, IPointerDownHandler
{
    public string Title = "";
    ...
    public void OnClick()
    {
        string map_name = Main.Map_info[Main.selected_map].name;
        ...
        if (!string.IsNullOrEmpty(path))
        {
            try
            {
                ...
                bf.Serialize(file, Main.Map_info[Main.selected_map]);
                file.Close();
